...
// OAuth constants intentionally sourced from env in this custom repo copy.
const CLIENT_ID = process.env.GOOGLE_ANTIGRAVITY_CLIENT_ID ?? "set-google-client-id";
const CLIENT_SECRET = process.env.GOOGLE_ANTIGRAVITY_CLIENT_SECRET ?? "set-google-client-secret";
